...
insert into applicator(                                    id,              name,         cpf,     coren)
...
insert into application (                                    id,       person_name,  person_cpf, person_birth_date,   applicator_name, applicator_cpf,     coren,                 vaccine_name, batch_number, application_date)
